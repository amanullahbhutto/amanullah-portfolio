...
<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between gap-3 mb-4">
    ...
    <div class="d-flex align-items-center justify-content-center">
        @if(isset($summary['journey_duration']))
    ...
    <div id="tasbeehs-grid-container" class="admin-list-results">
        <div class="row g-3 g-md-4">
            @forelse($tasbeehs as $t)
                <div class="col-12 col-lg-6 d-flex" id="tasbeeh-card-{{ $t->id }}" data-daily-target="{{ $t->daily_target }}" data-active-days="{{ $t->stats['active_days'] ?? 1 }}" data-today-completed="{{ $t->stats['today_completed'] ?? 0 }}" data-total-completed="{{ $t->stats['total_completed'] ?? 0 }}" data-total-required="{{ $t->stats['total_required'] ?? $t->daily_target }}" data-tracking-start-date="{{ $t->stats['tracking_start_date'] ?? '' }}" data-render-date="{{ now()->format('Y-m-d') }}" data-base-today-completed="{{ $t->stats['today_completed'] ?? 0 }}" data-base-today="{{ $t->stats['today_completed'] ?? 0 }}" data-base-total-completed="{{ $t->stats['total_completed'] ?? 0 }}" data-base-total="{{ $t->stats['total_completed'] ?? 0 }}">
