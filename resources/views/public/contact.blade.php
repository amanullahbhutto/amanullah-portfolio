    ...
    <div class="contact-panel"><div class="row g-0">
        ...
        <div class="col-lg-7"><div class="contact-form-wrap"><form method="POST" action="{{ route('contact.store') }}">@csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6"><label class="form-label" for="subject">Subject *</label><input class="form-control" id="subject" name="subject" value="{{ old('subject', request('hire') ? 'Hiring inquiry' : (request('service') ? 'Project inquiry: '.str_replace('-', ' ', request('service')) : '')) }}" required maxlength="150" placeholder="Project inquiry"></div>
