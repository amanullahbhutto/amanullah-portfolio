                ...
                <div class="col-md-6 col-xl-4" data-aos="fade-up" data-aos-delay="{{ ($loop->index % 3) * 80 }}">
                    <article class="project-card">
                        ...
                        <div class="project-body">
                            ...
                            <p>{{ $project->excerpt }}</p>
                            <ul class="tech-list">@foreach(array_slice($project->technologies ?? [], 0, 4) as $technology)<li>{{ $technology }}</li>@endforeach</ul>
                            <a class="card-arrow" href="{{ route('projects.show', $project) }}">View case study <i class="bi bi-arrow-up-right ms-2"></i></a>
                        </div>
                    </article>
                </div>
            @endforeach
